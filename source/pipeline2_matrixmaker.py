...
class PipelineMatrixMakerTest(unittest.TestCase):
    ...
    def test_01_matrix_builder(self):
        ...
        for subject_id in self.subjects:
            input_sliding_window = temp_path + "6_{}_{}_svar_SlidingWindow_filter.csv".format(DB, subject_id)
            input_trimers_weights = temp_path + "7_{}_{}_VarRemain_trimer_weights.p".format(DB, subject_id)
            input_vocab = temp_path + "5_{}_{}_filtered_trimers_VarRemain.csv".format(DB, subject_id)
            output_file = dir_path + "\\{}_{}_matrix".format(DB, subject_id)
    ...
    def test_02_barcodes_creator(self):
        ...
        for subject_id in self.subjects:
            input_temp_kmer_path = temp_path + "3_{}_{}_VarRemain.csv".format(DB, subject_id)
            output_file = dir_path + "\\{}_{}_barcodes.tsv".format(DB, subject_id)
    ...
    def test_03_feature_creator(self):
        ...
        for subject_id in self.subjects:
            input_temp_trimer_path = temp_path + "5_{}_{}_filtered_trimers_VarRemain.csv".format(DB, subject_id)
            output_file = dir_path + "\\{}_{}_genes.tsv".format(DB, subject_id)
